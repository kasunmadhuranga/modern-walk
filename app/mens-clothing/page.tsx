...
import { menProducts } from '../services/productService';
import Card from '../components/Card';
import { Product } from '../models/productModel';
import useFetch from '../hooks/useFetch';

const MensClothing: React.FC = () => {
    const { data: products, loading, error } = useFetch<Product[]>(menProducts);
            ...
            {loading ? (
                ...
                <div className='container mx-auto p-4 font-roboto bg-custom-white'>
                    <div className='max-w-[90%] sm:max-w-[90%] md:max-w-[90%] lg:max-w-[90%] xl:max-w-[90%] mx-auto'>
                        <h1 className="text-2xl font-bold mb-6 mt-6">Men&apos;s Clothing</h1>
